...
5. Specifically, I noticed that the code contains something like `1 * (parseInt`, this is a special treatment of the order of the array of strings. We have to adjust the strings in `Ef`, `gl`, `cp` accordingly.
